...
add_channel_button = KeyboardButton('/add_channel')
add_keyword_button = KeyboardButton('/add_keyword')
remove_channel_button = KeyboardButton('/remove_channel')
remove_keyword_button = KeyboardButton('/remove_keyword')
keyboard.row(subscribe_button, unsubscribe_button, list_button)
keyboard.row(add_channel_button, add_keyword_button, remove_channel_button, remove_keyword_button)
...
async def subscribe(message: types.Message):
    ...
    await message.reply("You are subscribed. You will receive messages with keywords.", reply_markup=keyboard)
...
async def unsubscribe(message: types.Message):
    ...
    await message.reply("You are unsubscribed. You will no longer receive messages with keywords.", reply_markup=keyboard)
...
async def remove_channel(message: types.Message):
    try:
        ...
        await message.reply(f"Channel {channel} removed successfully.", reply_markup=keyboard)
    except IndexError:
        await message.reply("Please provide a channel name after the command.", reply_markup=keyboard)
    except ValueError:
